...
if __name__ == "__main__":
    ...
    print("NO2 Air Quality: ", air_qualities[1][0], "\n")
    print("SO2 Air Quality: ", air_qualities[1][1], "\n")
    print("PM10 Air Quality: ", air_qualities[1][2], "\n")
    print("O3 Air Quality: ", air_qualities[1][3], "\n\n")
    print("Total Air Quality: ", air_qualities[0], "\n\n")
